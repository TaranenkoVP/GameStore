...
{
    public class GameStoreDbContextInitializer : DropCreateDatabaseIfModelChanges<GameStoreDbContext>
    {
        protected override void Seed(GameStoreDbContext context)
        {
            ...
            var g1 = new Game { Key="WOW", Name = "World of Warcraft", Description = "The good game", Genres = new[] { genre1, genre2, genre3, genre4 }, PlatformTypes = new[] { p1, p2 } };
            var g2 = new Game { Key = "Civ", Name = "Civilization", Description = "The new game" };
            var g3 = new Game { Key = "NFS", Name = "Need for speed", Genres = new[] { genre1,  genre3 }, PlatformTypes = new[] { p1 } };
